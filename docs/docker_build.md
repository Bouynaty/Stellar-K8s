...
## CI integration
Multi-arch images are built and published by the GitHub workflow [`.github/workflows/release.yml`](../.github/workflows/release.yml). Release re-tagging is handled by [`.github/workflows/release.yml`](../.github/workflows/release.yml).
